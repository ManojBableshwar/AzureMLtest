...
# else install private CLI
    ...
    az extension add --source https://azuremlsdktestpypi.blob.core.windows.net/wheels/azureml-v2-cli-e2e-test/65837203/ml-0.0.65837203-py3-none-any.whl --pip-extra-index-urls https://azuremlsdktestpypi.azureedge.net/azureml-v2-cli-e2e-test/65837203 --yes || {
    echo "ML CLI installation failed"
    exit 1
  }
fi
