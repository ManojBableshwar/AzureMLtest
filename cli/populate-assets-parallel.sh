...
start_time=`date +%s`
az ml component create --file $c_file --name $c_name --version $c_version --set display_name="$c_display_name" environment=azureml://registries/$REGISTRY/environments/publicimageexample/labels/latest $reg_var  || {
